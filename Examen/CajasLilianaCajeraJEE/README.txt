...
a persistence unit "CajasLilianaCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "CajasLilianaCajeraJEE\pom.xml":
...
artifact ("CajasLilianaCajeraJEE.war") is already built. You can build
