...
a persistence unit "SRIPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "SRI\pom.xml":
...
artifact ("SRI.war") is already built. You can build
