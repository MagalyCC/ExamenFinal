...
a persistence unit "CajasLilianaOperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "CajasLilianaOperadoraJEE\pom.xml":
...
artifact ("CajasLilianaOperadoraJEE.war") is already built. You can build
